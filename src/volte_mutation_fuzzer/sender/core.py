...
class SIPSenderReactor:
    ...
    def _send_real_ue_direct(
        ...
        *,
        ...
        # Legacy compatibility path: delegate send to container netns only when
        # no native IPsec path or explicit host-side spoofed source IP is configured.
    ...
    def _send_via_container(
        ...
        *,
        ...
        observer_events.append(f"container-send:legacy:{container}")
