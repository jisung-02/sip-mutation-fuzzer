...
- Methods / Response Codes도 이제 [`SIP-IANA-메서드-응답코드-전수조사.md`](SIP-IANA-메서드-응답코드-전수조사.md)에서 IANA inventory 기준으로 별도 정리했다. UE 관점 필드 의미 설명은 [`../sip-official-fields.md`](../sip-official-fields.md)를 같이 본다.
