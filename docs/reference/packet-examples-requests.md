...
```text
INVITE sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-generic
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: generic-request@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 INVITE
Content-Length: 0
```
...
```text
ACK sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-ack
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: ack@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 ACK
Route: <sip:edge.ims.mnc001.mcc001.3gppnetwork.org;lr>
Content-Length: 0
```
...
```text
BYE sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-bye
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
```text
CANCEL sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-cancel
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
### 조건부 규칙
- `Route`: If the original request established a route set, CANCEL follows the same route set.
...
```text
INFO sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-info
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
```text
INVITE sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-invite
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: invite@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 INVITE
...
```text
MESSAGE sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-message
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: message@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 MESSAGE
...
```text
NOTIFY sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-notify
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: notify@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 NOTIFY
Contact: <sip:222222@10.20.20.9>
Event: presence
...
<?xml version="1.0"?>
<presence entity="sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org"/>
```
...
### 조건부 규칙
- `Event`: The NOTIFY Event package must match the subscription or implicit REFER subscription it is reporting on.
- `Subscription-State`: Subscription-State drives whether expires is required (active/pending) or forbidden (terminated).
- `Body`: If a body is present, its format must be acceptable to the subscriber; many event packages send a body, but empty NOTIFY is possible for some terminal states.
...
```text
OPTIONS sip:ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-options
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
```text
PRACK sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-prack
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
```text
PUBLISH sip:presence.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-publish
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
...
<?xml version="1.0"?>
<presence entity="sip:222222@ims.mnc001.mcc001.3gppnetwork.org"/>
```
...
```text
REFER sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-refer
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: refer@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 REFER
Contact: <sip:222222@10.20.20.9>
Refer-To: <sip:333333@ims.mnc001.mcc001.3gppnetwork.org>
Referred-By: <sip:referrer@ims.mnc001.mcc001.3gppnetwork.org>
Refer-Sub: false
Target-Dialog: dialog-1234@pcscf.ims.mnc001.mcc001.3gppnetwork.org;local-tag=ltag;remote-tag=rtag
Content-Length: 0
```
...
```text
REGISTER sip:registrar.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-register
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: register@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 REGISTER
Contact: <sip:222222@10.20.20.9>
Expires: 3600
Recv-Info: dtmf
...
```text
SUBSCRIBE sip:presence.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-subscribe
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
Call-ID: subscribe@pcscf.ims.mnc001.mcc001.3gppnetwork.org
CSeq: 1 SUBSCRIBE
Contact: <sip:222222@10.20.20.9>
Supported: 100rel, timer
...
### 조건부 규칙
- `Expires`: SUBSCRIBE requests SHOULD include Expires; Expires: 0 is used to fetch or terminate a subscription depending on context.
...
```text
UPDATE sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org SIP/2.0
Via: SIP/2.0/UDP pcscf.ims.mnc001.mcc001.3gppnetwork.org;branch=z9hG4bK-update
Max-Forwards: 70
From: "Caller" <sip:222222@ims.mnc001.mcc001.3gppnetwork.org>;tag=from-tag
To: <sip:111111@ue.ims.mnc001.mcc001.3gppnetwork.org>
